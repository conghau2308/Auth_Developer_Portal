...
export default function InvitationPage() {
    ...
    return (
        <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "var(--ol-bg)" }}>
            ...
            >
                ...
                <span className="text-[20px]" style={{ color: "var(--ol-muted)" }}>
                    Identity Provider
                </span>
            </header>
            ...
            <footer
                ...
                style={{ borderTop: "1px solid var(--ol-border)", color: "var(--ol-muted)" }}
            >
                <span>Wifakey Identity Provider &copy; {new Date().getFullYear()}</span>
                <span style={{ color: "var(--ol-border)" }}>·</span>
                <a href="/privacy" style={{ color: "var(--ol-muted)", textDecoration: "none" }}
                    onMouseEnter={e => (e.currentTarget.style.color = "var(--kw-text-strong)")}
                    onMouseLeave={e => (e.currentTarget.style.color = "var(--ol-muted)")}>
                    Privacy
                </a>
                <span style={{ color: "var(--ol-border)" }}>·</span>
                <a href="/terms" style={{ color: "var(--ol-muted)", textDecoration: "none" }}
                    onMouseEnter={e => (e.currentTarget.style.color = "var(--kw-text-strong)")}
                    onMouseLeave={e => (e.currentTarget.style.color = "var(--ol-muted)")}>
                    Terms
                </a>
